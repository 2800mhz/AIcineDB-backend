...
# ============================================================================
# UPLOAD ENDPOINT - MOVED TO backend/api/upload.py
# ============================================================================
# The upload endpoint has been refactored into a separate router module
# See: backend/api/upload.py
# Registered in app.include_router(upload_router) above
